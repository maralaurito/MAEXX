...
foreach ($transactions as $tx) {
    $txDate = substr($tx['timestamp'] ?? $tx['date'] ?? '', 0, 7);
    if ($txDate === $thisMonth) {
        $monthlySales += floatval($tx['total'] ?? 0);
        $monthlyOrders++;
    }
}
...
<title>Admin Dashboard - MAEXX</title>
...
<div class="main-wrapper">
    ...
    <div class="topbar">
        <div class="topbar-left">
            ...
            <p>Overview of your inventory and sales system</p>
        </div>
    ...
    <div class="page-content">
        ...
        <div class="summary-grid">
            <div class="summary-card card-blue">
                <div class="card-icon icon-blue"><i class="bi bi-box-seam-fill"></i></div>
                <div class="card-value"><?= $totalProducts ?></div>
                <div class="card-label">Total Products</div>
                <div class="card-sub">Active in the system</div>
            </div>
            <div class="summary-card card-green">
                <div class="card-icon icon-green"><i class="bi bi-currency-dollar"></i></div>
                <div class="card-value">₱<?= number_format($monthlySales, 0) ?></div>
                <div class="card-label">Sales This Month</div>
                <div class="card-sub"><?= $monthlyOrders ?> transactions recorded</div>
            </div>
            <div class="summary-card card-red">
                ...
                <div class="card-sub">Below minimum threshold</div>
            </div>
            <div class="summary-card card-orange">
                ...
                <div class="card-sub">Needs immediate restock</div>
            </div>
        </div>
            ...
            <div class="content-card">
                <div class="card-header-row">
                    <div>
                        ...
                        <p>Items below their minimum stock level</p>
                    </div>
                ...
                <table class="mini-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color:#64748b;"><?= $p['threshold'] ?> <?= htmlspecialchars($p['unit']) ?></td>
                            <td>
                                <?php if ($p['stock'] == 0): ?>
                ...
                <table class="mini-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="max-width:120px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"><?= htmlspecialchars($tx['product_name'] ?? '—') ?></td>
